...
x = np.arange(256)
axs2[0].plot(x, np.full(256, 1/256), "k--", lw=1.5, label="Uniform(0,255)")
...
x = np.arange(65536)
axs2[1].plot(x, np.full(65536, 1/65536), "k--", lw=1.5, label="Uniform(0,65535)")
...
x = np.linspace(0, 4294967295, 200)
axs2[2].plot(x, np.full(200, 1/4294967296), "k--", lw=1.5, label="Uniform(0,2³²−1)")
